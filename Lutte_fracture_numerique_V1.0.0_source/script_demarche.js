...
const demarchesCategories = [
    {
        ...
        color: '#6B46C1',
        items: [
            // CORRECTION: Titre plus précis pour FranceConnect
            { id: 1, title: 'Se connecter avec FranceConnect', desc: 'Votre identité numérique unique', icon: '🔑' },
    ...
    },
    {
        ...
        items: [
            ...
            { id: 5, title: 'Faire la déclaration trimestrielle du RSA', desc: 'Revenu de Solidarité Active', icon: '💳' }, // CORRECTION: Terme plus précis
    ...
    },
    {
        ...
        items: [
            ...
            // CORRECTION: Ajout du contexte 'en ligne'
            { id: 9, title: 'Prendre RDV en ligne (Doctolib)', desc: 'Consultation médicale en ligne', icon: '🩺' },
    ...
    },
    {
        ...
        color: '#f59e0b',
        items: [
            // CORRECTION: Ajout du canal 'en ligne'
            { id: 12, title: 'Demander sa retraite en ligne', desc: 'Démarche Carsat', icon: '📑' },
    ...
    },
    {
        ...
        items: [
            ...
            // CORRECTION: Description plus complète
            { id: 25, title: 'S\'inscrire et s\'actualiser à France Travail', desc: 'Inscription et actualisation', icon: '💼' }
        ]
    }
];
...
const demarchesGuides = {
    ...
    1: {
        title: 'Se connecter avec FranceConnect pour les démarches',
        steps: [
            "FranceConnect n'est pas un compte séparé : **il sert de pont sécurisé entre vous et les services publics.** Allez sur franceconnect.gouv.fr pour en savoir plus.",
    ...
    3: {
        ...
        steps: [
            "Un bon mot de passe doit contenir au moins **15 caractères** (selon la recommandation NIST 2025).", 
            ...
            "Ne changez pas périodiquement sauf en cas de compromission.", 
    ...
    4: {
        ...
        steps: [
            "Contactez le **Conseil Départemental** de votre lieu de résidence ou allez sur service-public.fr pour obtenir le formulaire de demande d'APA.",
            "Téléchargez le formulaire de demande (Cerfa n°14732).",
    ...
    5: {
        title: 'Faire la déclaration trimestrielle du RSA',
        steps: [
    ...
    7: {
        ...
        steps: [
            ...
            "Envoyez à votre caisse de retraite (CNAV, MSA...) qui vous versera la prestation.", // Clarification
    ...
    8: {
        ...
        steps: [
            "Préparez : numéro Sécurité Sociale définitif (13 chiffres), **un RIB dont les coordonnées bancaires sont déjà connues de votre CPAM**, carte Vitale.",
            "Allez sur assure.ameli.fr ou téléchargez l'app 'Compte ameli'.",
            "Cliquez sur 'Créer un compte'.",
            "Entrez votre numéro de Sécurité Sociale (13 chiffres uniquement, pas la clé).",
            "Renseignez votre date de naissance et code postal de résidence.",
            "Entrez les détails du RIB déjà transmis à votre CPAM (IBAN).",
            "Créez un mot de passe fort (min. 8 caractères : 1 majuscule, 1 minuscule, 1 chiffre ou caractère spécial).",
            "Validez via le lien reçu par email (dans les 7 jours, vérifiez les spams).",
            "Alternative plus rapide : Connexion via FranceConnect (Impôts, La Poste, MSA, France Identité).",
            "Note : Seuls les assurés du régime général et certains régimes partenaires (MGEN depuis nov 2025) peuvent créer un compte."
        ]
    },
    9: {
    ...
    10: {
        ...
        steps: [
            ...
            "Cliquez sur 'Attestation de vaccination' (pour COVID ou autres).", 
    ...
    11: {
        title: 'Activer Mon Espace Santé', 
        steps: [
    ...
    12: {
        title: 'Demander sa retraite en ligne',
        steps: [
    ...
    15: {
        ...
        steps: [
            "Préparez : numéro fiscal (13 chiffres), numéro d'accès, revenu fiscal de référence.", 
            ...
            "Sans FranceConnect : Entrez votre **numéro fiscal**, **numéro d'accès en ligne** et **revenu fiscal de référence**.",
    ...
    18: {
        ...
        steps: [
            ...
            "Cherchez 'Carte Avantage Senior' (60+).", 
    ...
    19: {
        ...
        steps: [
            "Éligible si 62+ en Île-de-France.", 
    ...
    20: {
        ...
        steps: [
            ...
            "Le renouvellement via l'ANTS est nécessaire **uniquement en cas de perte, vol, ou pour les catégories lourdes**.",
    ...
    24: {
        ...
        steps: [
            "Utilisez un outil en ligne gratuit comme Canva ou Indeed.", 
    ...
    25: {
        title: 'S\'inscrire à France Travail en ligne', 
        steps: [
            "Allez sur france-travail.fr.", 
